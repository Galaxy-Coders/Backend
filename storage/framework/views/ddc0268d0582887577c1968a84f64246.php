        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-secondary text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <a class="btn btn-warning" href="<?php echo e(route('books.create')); ?>">Qo'shish</a>
                </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($book->ganre); ?></td>
                                    <td style="width: 200px !important;overflow:hidden;"><?php echo e($book->about); ?></td>
                                    <td style="display: flex; justify-content: space-evenly;">
                                        <a class="btn btn-sm btn-success" href="<?php echo e(route('books.edit', ['book' => $book->id])); ?>">
                                            <img src="./adminImg/edit.png" alt="edit icon" width="20px" height="20px">
                                        </a>
                                        <form action="<?php echo e(route('books.destroy', ['book' => $book->id])); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /Users/bek/Documents/AdminPage/resources/views/adminPage/index.blade.php ENDPATH**/ ?>